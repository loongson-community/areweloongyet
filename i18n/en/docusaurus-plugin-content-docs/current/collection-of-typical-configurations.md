...
The firmware used to collect this data is a test version with the graphical display feature removed to support AMD GPUs based on the Navi architecture. The kernel also includes some extra drivers and in-development features.
...
```c
// Compile and run the following C program, then paste the output here.
// Replace this code with the output and remove “c” from the fenced code block’s language label.
#include <stdio.h>
